...
type AddBookToReadList struct {
	BookId uint `json:"book_id" validate:"required,min=1"`
}

func (r bookRouter) AddBookToReadList(c *fiber.Ctx) error {
	...
	return c.SendString("Book added to read list")
}
